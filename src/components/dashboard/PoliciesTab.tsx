...
export function PoliciesTab({ policies: initialPolicies = {}, onRefresh }: PoliciesTabProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-bold text-[#141413] flex items-center gap-2">
              <Sliders className="h-5 w-5 text-[#141413]" />
              Merchant Autonomy Policy Boundaries
            </h2>
            <Badge variant="default">Hard Guardrails</Badge>
          </div>
      ...
      {saveMessage && (
        <div className="rounded-xl border border-[#C3E6D0] bg-[#EBF5EF] p-3.5 text-xs text-[#1E824C] font-semibold">
          {saveMessage}
        </div>
      )}
      ...
      <Card>
        <div className="pb-3 border-b border-[#E3DDD2] flex items-center justify-between">
          ...
          <span className="text-xs text-[#6B6862]">Updates take effect immediately</span>
        </div>
        ...
        <form onSubmit={handleSave} className="mt-5 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-[#141413] flex items-center justify-between">
                ...
                <span className="font-mono text-[#141413] font-bold">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#E3DDD2] bg-[#F5EFE2] px-3.5 py-2.5 text-xs text-[#141413] font-mono focus:border-[#141413] focus:outline-none transition-all"
              />
          ...
          <div className="pt-4 border-t border-[#E3DDD2] flex items-center justify-end">
            <button
              type="submit"
              disabled={isSaving}
              className="px-6 py-2.5 rounded-full bg-[#EB001B] hover:bg-[#D40018] text-xs font-semibold text-[#FFF9EC] shadow-sm transition-all flex items-center gap-2 disabled:opacity-50 active:translate-y-0.5"
            >
